...
const Features = () => {
    const features = [
        ...
        },
        {
            ...
            title: 'AI Captions & Caption Editing',
            description: 'OpenAI-powered captions transcribe your video with high accuracy. Highlight any caption line and delete it — that segment is instantly cut from your video, no timeline scrubbing needed.',
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
